...
For example, consider [Figure L-3](vol1_appl.md#applfig03). This figure notes the root, RPs, and DPs and each switch's least cost to reach the root over its respective RP.
